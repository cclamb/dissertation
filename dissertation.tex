...
\definecolor{idlred}{rgb}{0.6,0,0} % for strings
\definecolor{idlgreen}{rgb}{0.25,0.5,0.35} % comments
\definecolor{idlpurple}{rgb}{0.5,0,0.35} % keywords
...
\lstset{
	...
	keywordstyle=\color{idlpurple}\bfseries,
	stringstyle=\color{idlred},
	commentstyle=\color{idlgreen},
	frame=shadowbox,
