...
\begin{small}
\begin{itemize}
\item Rerouting may provide the best compromise between confidentiality and integrity, but an a potentially high availability, and likely financial, cost.  Maintaining dual infrastructures, especially if the second is highly secure, will more than double infrastructure spend.
