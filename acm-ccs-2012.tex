...
\conferenceinfo{ACM CCS}{'12 Raliegh, NC USA}
...
\category{H.3.4}{Information Systems}{Information Storage and Retrieval} : {Systems and Software}

\terms{Security, Design, Experimentation}

\keywords{Security, Usage Management, Access Control, Overlay Networks}
